    /*
     * By- Nimit Khandelwal
     * ARDUINO UNO EXAMPLE -ESP8266 HTTP-GET request
     * This example code is used to interface esp8266 module to arduino uno-r3.
     * Here esp8266 has been setup on station mode to perform HTTP GET request to server.
     */
     #include <SoftwareSerial.h>
    #define SSID        "TIGER hostel"
    #define PASS        "ughostel@boys"
    //   #define SSID        "Hol U19"
  // #define PASS        "12345679z"
    #define DEST_HOST   "172.16.7.128"
    #define DEST_IP     "172.16.7.128"
  ...
  SoftwareSerial dbgSerial(6, 7);
    ...
    void setup()  
    {
      ...
      echoCommand("AT+CIPMUX=0", "", HALT);    // Allow single connection (we'll only use the first).
